...
# main url
url = "https://www.zalando.co.uk/kids-home/"


async def get_source_by_playwright(url: str, user_agent: str = user_agent, wait_until: str = 'domcontentloaded', timeout: int = 40000) -> BeautifulSoup:
